...
def graph():
    ...
    plt.ylabel(r'$\theta_2$[rad]', fontsize=20)
    plt.yticks(fontsize=20)
    plt.xlim(0,t)
    plt.xticks(fontsize=20)
    plt.grid(color='dimgrey')
    ...
    plt.yticks(fontsize=20)
    plt.ylabel(r'$\omega_1[\frac{rad}{s}]$', fontsize=20)
    plt.xlim(0,t)
    plt.xticks(fontsize=20)
    plt.grid(color='dimgrey')
    ...
    plt.xlabel('t[s]', fontsize=20)
    plt.yticks(fontsize=20)
    plt.ylabel(r'$\omega_2[\frac{rad}{s}]$', fontsize=20)
    plt.xlim(0,t)
    plt.xticks(fontsize=20)
    plt.grid(color='dimgrey')
...
def trajectory():
    ...
    plt.xticks(np.arange(-(l1 + l2), l1 + l2 + 0.1, 1), fontsize=20)
    plt.yticks(np.arange(-(l1 + l2), l1 + l2 + 0.1, 1), fontsize=20)
